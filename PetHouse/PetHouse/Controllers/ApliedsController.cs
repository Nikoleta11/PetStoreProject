...
namespace PetHouse.Controllers
{
    public class ApliedsController : Controller
    {
        ...
        {
            return View(await _context.Aplied.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var aplied = await _context.Aplied
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var aplied = await _context.Aplied.FindAsync(id);
            if (aplied == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Aplied.Any(e => e.Id == id);
        }
    }
}
